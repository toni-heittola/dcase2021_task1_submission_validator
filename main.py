#!/usr/bin/env python
# -*- coding: utf-8 -*-
# DCASE 2021 Challenge Task 1: Submission validator
# ---------------------------------------------
            ...
            'meta': {
                ...
                'results': {
                    ...
                    'development_dataset': {
                        ...
                        'overall': {
                            'required_fields': ['logloss', 'accuracy'],
                        },
                        'class_wise': {
                            'required_fields': ['airport', 'shopping_mall', 'metro_station', 'street_pedestrian',
                                                'public_square', 'street_traffic', 'tram', 'bus', 'metro', 'park'],
                            'required_fields_per_item': ['logloss', 'accuracy']
        ...
        'B': {
            ...
            'meta': {
                ...
                'system': {
                    'required_fields': ['description', 'complexity', 'external_datasets', 'source_code'],
                    'description': {
                        'required_fields': ['input_channels', 'input_sampling_rate', 'acoustic_features',
                                            'audio_embeddings', 'visual_embeddings', 'data_augmentation',
                                            'machine_learning_method', 'ensemble_method_subsystem_count',
                                            'modality_combination', 'decision_making',
                                            'external_data_usage'],
                    },
                    'complexity': {
                        'required_fields': ['total_parameters', 'total_parameters_audio', 'total_parameters_visual']
                    },
                    'external_datasets': {
                        'required_fields': ['name', 'url', 'total_audio_length']
                    }
